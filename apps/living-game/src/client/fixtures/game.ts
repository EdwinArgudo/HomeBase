  ...
  personas: [
    {
      id: "persona-edwin",
      displayName: "Edwin",
      altDescription: "Edwin's companion watering the window plants.",
    ...
    },
    {
      id: "persona-vienna",
      displayName: "Vienna",
      altDescription: "Vienna's companion reading on the sofa.",
      visibility: "household",
      activity: "read",
      appearance: { species: "cat", palette: "butter", pattern: "spots", accessory: "scarf" },
  ...
  personas: [
    {
      id: "persona-edwin",
      displayName: "Edwin",
      altDescription: "Edwin's companion enjoying a calm morning at home.",
      visibility: "display",
      activity: "idle",
      appearance: { species: "bunny", palette: "mint", pattern: "belly", accessory: "bow" },
    ...
    },
    {
      id: "persona-vienna",
      displayName: "Vienna",
      altDescription: "Vienna's companion reading by the window.",
      visibility: "display",
      activity: "read",
      appearance: { species: "cat", palette: "butter", pattern: "spots", accessory: "scarf" },
      equippedRewardKey: null,
